"""
Django settings for APML project.
...
SECRET_KEY = "django-insecure-*p6seu7h1y!1f)&n-d^(&_3pqnp#=dk%x&%r9$hett3h94^)pf"
...
WSGI_APPLICATION = "APML.wsgi.application"
